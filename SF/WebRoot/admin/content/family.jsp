...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
    ...
    <form action="ContentAction.do" method="post" onsubmit="doSub(this);return false;">
   		<input type="hidden" name="method" id="method" value="showFamily"/>
        ...
        <div id="wrapper">			
			...
			<table width="100%" border="1" align="center" cellpadding="0" bordercolor="#0099CC" cellspacing="1" style="border-collapse: collapse;border:#c8c8e7 1px solid; border-top:0; margin-top:20px;">
			  ...
			  <c:forEach items="${families}" var="f" varStatus="status">
			  <tr>
			    <td height="26" colspan="" style="text-align: center;">
				<input name="id_check" value="${f.id }" type="checkbox"/>
				</td>
				<td height="26" colspan="" style="padding-left: 30px;">
				<input name="orderNum_${f.id}" value="${f.orderNum }" type="text" size="5"/>
				</td>
				<td height="26" colspan="" style="padding-left: 30px;">
				${f.name }
				</td>
				...
				<td height="26" colspan="" style="padding-left: 30px;">
				<a href="javascript:fill(${f.id },'${f.orderNum }','${f.name }','${f.idText }','${f.version }','${f.groupNum }')">修改信息</a>
				</td>
			  </tr>
			  </c:forEach>
			  <tr>
