...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
    ...
    <form action="ProductAction.do" method="post">
        ...
        <div id="wrapper">		
			...
			<table width="100%" border="1" align="center" cellpadding="0" bordercolor="#0099CC" cellspacing="1" style="border-collapse: collapse;border:#c8c8e7 1px solid; border-top:0; margin-top:25px;">
			  <tr>
			  	<td height="26" colspan="" align="center" background="../images/msg_bg.jpg">
				<strong>排列顺序</strong> 
				</td>
			  ...
			  <tr>
			  	<td height="26" colspan="" style="text-align: center;">
			    	<input name="order" value="${catalog.order}"/>
				</td>
			    <td height="26" colspan="" style="text-align: center;">
			    	<input name="catalogName" value="${catalog.catalogName }"/>
				</td>
				<td height="26" colspan="" style="text-align: center;">
			    	<input name="catalogURL" value="${catalog.catalogURL }"/>
				</td>
				<td height="26" colspan="" style="text-align: center;">
				<a href="javascript:void();" target="_self" onclick="">删除</a>
				</td>
			  </tr>
			  </c:forEach>
			</table>				
