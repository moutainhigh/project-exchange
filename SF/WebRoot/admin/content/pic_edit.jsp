...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
    <head>
		...
		<script>
			...
			window.top["fillFilePath"] = function(){
				...
				//var img = new Image();
				//document.getElementById("fileSpan").appendChild(img);
				//img.src = "${app_path}/upload/"+document.getElementById("filePath").value;
				document.getElementById("fileSpan").innerHTML = '<img src="'+'${app_path}/upload/'+path+'" width="100" height="100"/>';
				alert(document.getElementById("fileSpan").innerHTML);
				//$("#fileSpan").show();
			};
			function doSub(f){
				f.submit();
    ...
    <form action="PicAction.do" method="post" onsubmit="doSub(this);return false;">
   		<input type="hidden" name="method" id="method" value="savePic"/>
   		<input type="hidden" name="dId" id="dId" value="${p.id }"/>
        <div id="wrapper">			
        	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#c8c8e7 1px solid; border-top:0; margin-top:5px;">
			  <tr>
				...
				&nbsp;&nbsp;<img src="./images/ico1.gif" border="0" align="absmiddle" /> <strong>宣传图片信息编辑</strong> </td>
			  </tr>
			  <tr>
			    <td width="18%" height="25" align="right" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">标题：</td>
			    <td width="82%" align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;<input type="text" name="title" value="${p.title }"/></td>
			  </tr>
			  <tr style="background-color:#F7F8FA">
			    <td height="25" align="right" bgcolor="#F7F8FA" style="border-bottom:#cccccc 1px dashed;">图片上传：</td>
			    <td align="left" bgcolor="#F7F8FA" style="border-bottom:#cccccc 1px dashed;">&nbsp;
			    	<input type="hidden" id="filePath" name="filePath" value="${p.filePath }"/>
			    	<span id="fileSpan">
