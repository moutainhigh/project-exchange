        ...
        <div id="wrapper">			
			<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" style="border:#c8c8e7 1px solid; border-top:0; margin-top:5px;border-collapse: collapse;">
			  <tr>
				...
				&nbsp;&nbsp;<img src="./images/ico1.gif" border="0" align="absmiddle" /> <strong>单页内容管理</strong><span style="color: red;">${msg }</span> </td>
			  </tr>
			  <tr>
			    <td width="20%" height="25" align="right" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">页面：</td>
			    <td width="80%" align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;
			    	<select name="contentId" id="contentId" onchange="document.forms[0].submit();">
			    		<option value="">==请选择页面==</option>
			    		<option value="1" <c:if test="${contentId==1}">selected="selected"</c:if>>特殊符号</option>
			    		<option value="2" <c:if test="${contentId==2}">selected="selected"</c:if>>广告联系</option>
			    	</select>
			    	<span id="span001" style="color:red;">请选择一个页面</span>
			    </td>
			  </tr>
			  <tr>
			    ...
			    <td align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;
			    	...
			    	<div align="left"> 
		                <textarea name="content"  id="content" style="width:780; height:400px;">${content }</textarea><%--width is 730px, it is same to 700px of front --%>
