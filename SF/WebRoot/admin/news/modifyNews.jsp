...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" dir="ltr">
    ...
    <form action="${app_path }/manage/NewsAction.do" method="post">
   		<input type="hidden" name="method" value="modifyNews"/>
        ...
        <div id="wrapper">			
			<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" style="border:#c8c8e7 1px solid; border-top:0; margin-top:5px;border-collapse: collapse;">
			  <tr>
				...
				&nbsp;&nbsp;<img src="./images/ico1.gif" border="0" align="absmiddle" /> <strong>修改新闻信息</strong> </td>
			  </tr>
			  <tr>
			    <td width="20%" height="25" align="right" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">标题：</td>
			    <td width="80%" align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;<input type="text" name="title" style="width:300px;" value="${news.title }"/></td>
			  </tr>
			  <tr>
			    <td height="25" align="right" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">作者：</td>
			    <td align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;<input type="text" name="author" style="width:100px;" value="${news.author }"/></td>
			  </tr>
			  <tr>
			    ...
			    <td align="left" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px dashed;">&nbsp;
			    	...
			    	<div align="left"> 
		                <textarea name="content"  id="content" style="width:780; height:400px;">${news.content }</textarea><%--width is 730px, it is same to 700px of front --%>
