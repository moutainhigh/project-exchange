    ...
    <head>
		...
		<script>
			function deletePro(id){
				...
				self.location.href = "${app_path}/manage/ProductAction.do?method=deletePro&id="+id;
			}
		</script>
    </head>
    <body>
        ...
        <div id="wrapper">			
			<table width="100%" border="1" align="center" cellpadding="0" bordercolor="#0099CC" cellspacing="1" style="border-collapse: collapse;border:#c8c8e7 1px solid; border-top:0; margin-top:5px;">
			  ...
			  <tr>
				...
				<td height="26" colspan="" style="padding-left: 30px;">
				<a href="javascript:void();" target="_self" onclick="deletePro(${p.id });">删除</a>
				&nbsp;
				<a href="${app_path}/manage/ProductAction.do?method=gotoModify&id=${p.id }" target="_self">修改</a>
				</td>
			  </tr>
			  </c:forEach>
			  <tr>
