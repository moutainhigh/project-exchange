...
<div class="wrapper mauto pad_5">
      <div class="search_area">
        <div class="fl ft14 w550 hide">张家口汽车网 <a href="${appPath}/index.htm">首页</a> &gt; <a href="#">本地动态</a> &gt;</div>
          ...
          <div class="pad_20">
            ...
            <div class="sighrTab">
              <ul>
                ...
                <li class=""><a href="newsList.htm?news.orderNum=1" target="_blank">本地汽车新闻</a></li>
              </ul>
            </div>
                ...
                <div class="pages"> 
                	<c:choose>
						<c:when test="${!specialPageBean.isFirstPage}">
							...
							<a href="javascript:gotoPage(${specialPageBean.prePageIndex });" class="nextprev">上一页</a>
						</c:when>
						<c:otherwise>
					...
					<c:choose>
						<c:when test="${!specialPageBean.isLastPage}">
							<a href="javascript:gotoPage(${specialPageBean.nextPageIndex });" class="nextprev">下一页</a>
							<a href="javascript:gotoPage(${specialPageBean.maxPage });" class="nextprev">最后一页</a>
						</c:when>
						<c:otherwise>
