        ...
        <div id="menu3">
            <ul>
				<li><c:if test="${isAdmin}">
                    <a id="current" href="${appPath}/manage/ManageAction_cateList.htm" target="rightFrame">栏目列表</a>
                    <a id="current" href="${appPath}/manage/cate/cate_edit.jsp" target="rightFrame">添加栏目</a>
                    </c:if>
                </li>
            </ul>
        </div>
