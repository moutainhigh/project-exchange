        ...
        <div id="wrapper">			
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#c8c8e7 1px solid; border-top:0; margin-top:5px;">
			  ...
			  <tr style="font-weight: 600;">
			  	...
			  	<td width="10%" height="25" align="center" bgcolor="#FFFFFF" style="border-bottom:#cccccc 1px solid;">编号</td>
			  ...
			  <tr <c:if test="${status.count % 2 == 0}">bgcolor="#F7F8FA"</c:if>>
			    ...
			    <td align="center" style="border-bottom:#cccccc 1px dashed;">
			    	<a href="javascript:void(0);" onclick="deleteBrand(${c.id});">删除</a>
			    	&nbsp;
			    	<a href="${appPath}/manage/ManageAction_brand.htm?brand.id=${c.id}">修改</a>
			    </td>
			  </tr>
			  </c:forEach>
			</table>
