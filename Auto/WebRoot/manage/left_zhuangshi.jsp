    ...
    <body>
        ...
        <div id="menu3">
            <ul>
				<li>
					<c:if test="${isAdmin}">
                    <a id="current" href="${appPath}/manage/ManageAction_zhuangshiList.htm" target="rightFrame">装饰商家列表</a>
                    <a id="current" href="${appPath}/manage/zhuangshi/zhuangshi_edit.jsp" target="rightFrame">添加装饰商家</a>
                    </c:if>
                </li>
            </ul>
        </div>
