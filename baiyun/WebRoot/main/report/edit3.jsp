		...
		<form method="get" action="${appPath}report_saveReport3.action" name="searchForm">
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tables_search">
				<tbody>
					<tr>
						<td>
							您当前所处页面：报表维护&gt;&gt;对口帮扶低收入村项目建设及资金下拨明细表
						</td>
						<td align="right">&nbsp;
						</td>
						<td width="5px">&nbsp;</td>
				...
				<tbody>
					<tr align="center">
						...
						<td width="" class="tables_headercell" colspan="2">
							...
							<c:if test="${empty r3.type || r3.type=='month'}">
								<c:if test="${empty r3.lock || r3.lock==0 || r3.lock==3}">
								...
								<c:if test="${not empty r3.lock && r3.lock==1}">
					...
					<c:if test="${empty r3.id || r3.lock==0}">
					<tr>
