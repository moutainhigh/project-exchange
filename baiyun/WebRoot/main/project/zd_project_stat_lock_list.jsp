	...
	<head>
		...
		function unlockInfo(){
			if($('input:checked').length>0 && confirm('您确定解锁吗？')){
				document.forms[0].action = '${appPath}pro_unlockProZdStat.action';
...
.tables_search {
	...
	<body>
		<form method="get" action="${appPath}pro_proZdStatLockList.action" name="searchForm">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tables_table">
				<tbody>
					...
					<c:forEach items="${proZdStatList}" var="f">
						<tr>
