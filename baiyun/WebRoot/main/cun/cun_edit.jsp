...
<table height="100%" cellspacing="0" cellpadding="0" border="0" width="100%" class="tables_table">
	...
	<tr>
		...
		<td class="tables_contentcell" width="100">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.familyNum }" name="cun.familyNum"/></td>
		<td align="right" class="tables_leftcell">耕地面积</td>
		<td class="tables_contentcell">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.mianji }" name="cun.mianji"/></td>
		<td align="right" class="tables_leftcell">山地面积</td>
		<td class="tables_contentcell" width="100">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.house }" name="cun.house"/></td>
	</tr>
	<tr>
		<td height="30" align="right" class="tables_leftcell" width="100">2010年村集体收入</td>
		<td class="tables_contentcell" colspan="2">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.income }" name="cun.income"/></td>
		<td align="right" class="tables_leftcell" colspan="2">其中上级转移至村的收入</td>
		<td class="tables_contentcell" colspan="2">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.sjIncome }" name="cun.sjIncome"/></td>
		<td align="right" class="tables_leftcell">村集体土地</td>
		<td class="tables_contentcell" colspan="3">&nbsp;<input msg="必须为数字！" require="false" datatype="Integer" type="text" value="${cun.tudi }" name="cun.tudi"/></td>
	</tr>
	<tr>
		<td height="100" align="right" class="tables_leftcell" width="100">村集体现有基本基础设施与公共服务设施建设项目</td>
		<td class="tables_contentcell" colspan="9">&nbsp;
		<textarea rows="" cols="" name="cun.item">${cun.item }</textarea>
		</td>
	</tr>
	<tr>
		<td height="100" align="right" class="tables_leftcell" width="100">村现有资源</td>
		<td class="tables_contentcell" colspan="9">&nbsp;
		<textarea rows="" cols="" name="cun.res">${cun.res }</textarea>
		</td>
	</tr>
	<tr>
		<td height="100" align="right" class="tables_leftcell" width="100">村集体经济发展计划</td>
		<td class="tables_contentcell" colspan="9">&nbsp;
		<textarea rows="" cols="" name="cun.plan">${cun.plan }</textarea>
		</td>
	</tr>
	<tr>
		<td height="100" align="right" class="tables_leftcell" width="100">村两委干部基本情况</td>
		<td class="tables_contentcell" colspan="9">&nbsp;
		<textarea rows="" cols="" name="cun.con">${cun.con }</textarea>
		</td>
	</tr>
	<tr>
