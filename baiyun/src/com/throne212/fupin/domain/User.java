...
public class User extends MyEntity implements Serializable {
	...
	public String getRoleName() {
		...
		} else if (this instanceof CunWorkOrg) {
			return ((CunWorkOrg) this).getCun().getName() + "扶贫工作组•村级管理员";
	...
	public String getOrgName() {
		if (this instanceof ShiWorkOrg) {
			...
			return ((CunWorkOrg) this).getCun().getName() + "扶贫工作组";
		} else if (this instanceof WorkTeam) {
			WorkTeam team = ((WorkTeam) this);
			return team.getArea().getName() + "扶贫工作组•对应帮扶" + team.getZhen().getName();
		} else if (this instanceof Org) {
	...
	public boolean getIs206() {
		if (this != null && this instanceof Org) {
			Org o = (Org) this;
			if (o.getCun() != null) {
				if ("温泉镇".equals(o.getCun().getZhen().getName()) || "吕田镇".equals(o.getCun().getZhen().getName()) || "良口镇".equals(o.getCun().getZhen().getName())
						|| "鳌头镇".equals(o.getCun().getZhen().getName()) || "小楼镇".equals(o.getCun().getZhen().getName()) || "正果镇".equals(o.getCun().getZhen().getName())
						|| "派潭镇".equals(o.getCun().getZhen().getName()) || "流溪河林场".equals(o.getCun().getZhen().getName()) || "梯面镇".equals(o.getCun().getZhen().getName())) {
					return true;
				}
			}
		}
	...
	public boolean getZhengfu() {
		if (this != null && this instanceof Org) {
			Org o = (Org) this;
			if ("政府机关单位".equals(o.getTypeName())) {
				return true;
			} else {
				return false;
			}
