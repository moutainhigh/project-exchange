...
String mail=request.getParameter("mail");
 ...
 if(mail!=null&&(mail.length()==32||mail.length()==64||mail.length()==96)) {
 byte[] decryptFrom = com.throne212.jianzhi8.common.DESUtil.parseHexStr2Byte(mail);
  byte[] decryptResult =com.throne212.jianzhi8.common.DESUtil.decrypt(decryptFrom, "my.jianzhi8.com.eagle.email");
  if(decryptResult!=null)
   mail=new String(decryptResult);  
