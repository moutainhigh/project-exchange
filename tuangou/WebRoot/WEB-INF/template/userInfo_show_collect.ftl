...
<script type="text/javascript">
  ...
  <tr id="concerned_deal_173815">
    <td width="133" class="td_tc">
      <a rel="nofollow" target="_blank" href="${t.url!'http://'}" title="转到该团购的原始页">
        <img height="60" width="99" alt="${t.title!''}" src="upload/${t.img!'02.jpg'}" class="gmjl_img">
      </a>
    </td>
    <td width="380">
      <div class="gmjl_bt">
  ...
  <td width="132" valign="top" align="center">
    <a deal_id="173815" href="${base}/userCenter_deleteCollectTeam_action?team.id=${t.id}" title="从我的收藏中删除"  class="shcjl_sc">删除</a>
