						...
						<tr>
							<td class="pages" colspan="8">
								...
								<span style="display:block;float:right;">
									...
									<#if !pageBean.isFirstPage><a href="javascript:gotoPage(1,'${base}/admin/list.htm');">[首页]</a><#else>[首页]</#if>
									<#if !pageBean.isFirstPage><a href="javascript:gotoPage(${pageBean.prePageIndex },'${base}/admin/list.htm');">[前一页]</a><#else>[前一页]</#if>
									<#if !pageBean.isLastPage><a href="javascript:gotoPage(${pageBean.nextPageIndex },'${base}/admin/list.htm');">[后一页]</a><#else>[后一页]</#if>
									<#if !pageBean.isLastPage><a href="javascript:gotoPage(${pageBean.maxPage },'${base}/admin/list.htm');">[尾页]</a><#else>[尾页]</#if>
								</span>
