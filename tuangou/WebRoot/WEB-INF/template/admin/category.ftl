		...
		<div class="wrapper">
			...
			<div class="right">
				...
				<table cellspacing="0" cellpadding="0" border="0" class="modify-table">
					...
					<tbody>
						<tr>
							<td class="mt-td-l first">分类名称：</td>
							<td class="mt-td-r first">
								<input type="text" value="" maxlength="60" size="60" class="text" name="category.name" id="categoryName">
							</td>
						</tr>
						<tr>
							<td class="mt-td-l">拼音：</td>
							<td class="mt-td-r">
								<input type="text" value="" maxlength="60" size="60" class="text" name="category.pinyin" id="pinyin">
							</td>
						</tr>
						<tr>
							<td class="mt-td-l">编号：</td>
							<td class="mt-td-r">
								<input type="text" value="" class="text" name="category.orderNum" id="orderNum">
							</td>
						</tr>
						<tr>
							<td class="mt-td-l">&nbsp;</td>
				...
				<table cellspacing="0" cellpadding="0" border="0" class="list-table">
					<thead>
						<tr><th class="lt-th" colspan="8"><strong>已有分类数据</strong></th></tr>
					</thead>
					<tbody>
						<tr class="lt-title">
