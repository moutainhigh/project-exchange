...
<head>
	...
	<script type="text/javascript">
		...
		function deleteInfo(){
			if(confirm('您确定删除吗？') && $('input:checked').length>0){
				document.forms[0].action = '${base}/admin/deleteComments';
	...
	<body>
		...
		<div class="wrapper">
			<#include "left.ftl">
			<div class="right">
				<form enctype="multipart/form-data" method="post" action="${base}/admin/deleteComments">
				<table cellspacing="0" cellpadding="0" border="0" class="list-table">
					...
					<tbody>
						...
						<tr>
							...
							<input type="checkbox" value="${c.id}" name="comment_ids" class="comment_ids">
							</td>
