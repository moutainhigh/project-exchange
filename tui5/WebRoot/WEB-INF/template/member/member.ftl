			...
			<div class="left_body">
				<div class="item">
				    <div class="item-title">
					    <ul>
						    <li><img src="../img/member/arrow1.jpg"> 我是雇主</li>
					    </ul>
					</div>
					<div class="item-repeat">
					    <ul>
						    <li><img border="0" src="../img/member/tips.jpg"> <a href="../Task/addTask.asp"><font color="#0033FF">我要发布任务</font></a></li>
							<li><img border="0" src="../img/member/tips.jpg"> <a href="myTask.asp?Status=all">我发布的悬赏任务</a></li>
				...
				<div class="item">
				    <div class="item-title">
					    <ul>
						    <li><img src="../img/member/arrow1.jpg"> 我是推手</li>
						</ul>
					</div>
					<div class="item-repeat">
					    <ul>
				...
				<div class="item">
				    <div class="item-title">
					    <ul>
						    <li><img src="../img/member/arrow2.jpg"> 我的哈宝</li>
						</ul>
					</div>
					<div class="item-repeat">
				...
				<div style="overflow:hidden" class="item">
				    <div class="item-title">
					    <ul>
						    <li><img src="../img/member/arrow3.jpg"> 信息管理</li>
						</ul>
					</div>
					
					<div style="overflow:hidden" class="item-repeat2">
					    <ul>
						    <li><img border="0" src="../img/member/tips.jpg"> <a href="modify.asp">修改资料</a></li>
						    <li><img border="0" src="../img/member/tips.jpg"> <a href="password.asp">修改密码</a></li>
						</ul>
						<div style="clear:both"></div>
						<ul>
							<li><img border="0" src="../img/member/tips.jpg"> <a href="jb.asp">我的投诉</a></li>
							<li><img border="0" src="../img/member/tips.jpg"> <a href="sjb.asp">我收到的投诉</a></li>
						</ul>
						<div style="clear:both"></div>
						<ul>
						    <li><img border="0" src="../img/member/tips.jpg"> <a href="sendMsg.asp">发送信息</a></li>
							<li><img border="0" src="../img/member/tips.jpg"> <a href="outBox.asp">发件箱</a></li>
						</ul>
						<div style="clear:both"></div>
						<ul>
							<li><img border="0" src="../img/member/tips.jpg"> <a href="inBox.asp">收件箱</a></li>
							<li></li>
						</ul>
				  </div>
