...
$(function(){
	$("#logqq").click(function(){
		...
		//window.open('http://www.680.com/loginToqq.aspx?tourl=user','TencentLogin','width=450,height=320,menubar=0,scrollbars=0,status=1,titlebar=0,toolbar=0,location=1'); 
		alert('暂时不可用');
	});
