							...
							<tr>
					         ...
					         <td align="left">
					         	<select name="person.status">
					         		<option value=""></option>
					         		<option value="1" <c:if test="${param['person.status']==1}">selected="selected"</c:if>>正常</option>
					         		<option value="0" <c:if test="${param['person.status']==0}">selected="selected"</c:if>>已注销</option>
					         	</select>
					         </td>
					       </tr>
					       <tr>
			...
			<table width="90%" border="0" cellspacing="1" cellpadding="0" class=table align="center">
				...
				<tr class="list_td_context">
					...
					<td>
						...
						<a href="javascript:deletePerson(${d.id})">删除</a>
					</td>
				</tr>
				</c:forEach>
			</table>
