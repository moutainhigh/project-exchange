...
<html>
	...
	<body>
			...
			<table width="90%" border="0" cellspacing="1" cellpadding="0" align="center">
			    <tr>
			      <td height="18" align=center>
			        <font class=caption>出生证明数据字典 - ${dic_name }</font>
			      </td>
			    </tr>
			</table>
			<table width="90%" border="0" cellspacing="1" cellpadding="0" class=table align="center">
				...
				<form action="${appPath}/birth.do?method=saveDic" method="post">
				<tr class="list_td_context">
					...
					<td>
						<a href="${appPath}/birth.do?method=deleteDic&id=${d.id}&dicName=${param.dicName}">删除</a>
				...
				<tr>
					<td colspan="4" align="center">
						<input type="button" value="返回" onclick="javascript:self.location.href='${appPath}/birth.do?method=listDic'"/>
					</td>
				</tr>
			</table>
			<form action="${appPath}/birth.do?method=addDic" method="post" id="addForm" name="addForm">
