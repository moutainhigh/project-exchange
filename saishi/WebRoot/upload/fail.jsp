...
<form name="form1" method="post" action="${appPath}/admin/FileUploadAction.htm" enctype="multipart/form-data" >
  <table width="360" border="0" cellspacing="0" cellpadding="5" align="center" bordercolordark="#CCCCCC" bordercolorlight="#000000">
	<tr bgcolor="#CCCCCC"> 
      <th height="20" align="left" valign="middle" bgcolor="#CCCCCC" class="trYello">音乐上传失败</th>
    </tr>
    <tr bgcolor="#CCCCCC"> 
      <th height="20" align="left" valign="middle" bgcolor="#FF4500" class="trYello">上传失败原因:没有选择音乐文件或<p>音乐文件过大(请选择不超过10M的文件)</p></th>
    </tr>
