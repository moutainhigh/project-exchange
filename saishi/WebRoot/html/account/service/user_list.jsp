...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				var colArr = ['id','name','loginName',null,'remark'];
			...
			function deleteUser(id){
				if(window.confirm('您确定删除吗？')){
					self.location.href = '${appPath}data_deleteUser.action?user.id='+id;
				}
			}
			function query(){
				document.forms[0].action = "${appPath}data_userList.action";
	...
	<body>
		...
		<br />
		<form action="${appPath}data_userList.action" method="get">
		...
		<table class="data_list_table">
			...
			<tr>
				...
				<td class="list_data_op">
					<a href="${appPath}data_saveUser.action?user.id=${f.id}" >修改</a>
