...
srcMarquee.prototype.Start = function() {
	...
	msobj.Begin = function() {
		msobj.ClientScroll = msobj.Direction > 1 ? msobj.ID.scrollWidth
				: msobj.ID.scrollHeight;
		...
		msobj.ID.onmousemove = function(event) {
			if (msobj.ScrollStep == 0 && msobj.Direction > 1) {
				...
				if (window.event) {
					if (msobj.IsNotOpera) {
						msobj.EventLeft = event.srcElement.id == msobj.ID.id ? event.offsetX
								- msobj.ID.scrollLeft
