...
//		s.save(c3);
		...
		p1.setFileName("free-video-converter");
		p1.setImage("video-converter-box.jpg");
		p1.setName("DVDVideoMedia Free Video Converter");
		p1.setPrice(29.95);
		...
		p1.setShortName("Free Free Video Converter");
		p1.setSize("5.20Mb");
...
//"				DVDVideoMedia Free iPad Converter Suite integrates two useful software, including DVDVideoMedia Free DVD to iPad Converter software (iPad DVD software) and iPad Video Converter software. All these two kinds of software are great assistants to your iPad."+
//"<br>"+
//"DVDVideoMedia Free iPad Converter Suite provides powerful and professional functions. With this iPad software pack, you can rip any DVD files (DVD-Video, DVD folder and DVD IFO file) to iPad. Also you can convert all popular videos/audios to iPad formats. "+
//"<br>"+
//"Apart from the major functions, DVDVideoMedia Free iPad Converter Suite also provides lots of useful editing functions. You can trim, crop your videos. You can even join multiple pieces of videos or audios together as a single one. Moreover, DVDVideoMedia Free iPad Converter Suite enables you to adjust your video effect through the function of editing effect."+
// "</p>");
//		p2.setDownUrl("iPadConverterSuite.exe");
//		p2.setFileName("ipad-converter-suite");
//		p2.setImage("ipadconvertersuite-box.jpg");
//		p2.setName("DVDVideoMedia Free iPad Converter Suite");
//		p2.setPrice(24.95);
//		p2.setScreenShot("ipad-converter-suite-bk.jpg");
//		p2.setShortDesc("Integrates two useful software, including DVDVideoMedia Free DVD to iPad Converter software (iPad DVD software) and iPad Video Converter software. ");
//		p2.setSize("12.6Mb");
//		p2.setShortName("Free Free iPad Converter Suite");
//		p2.setOrderNum(1);
...
//"				DVDVideoMedia Free DVD Converter Suite is the perfect combination of DVDVideoMedia Free DVD Ripper, DVDVideoMedia Free Video Converter. With these powerful DVD Converter Suite, you can easily convert DVD and video to all the popular formats: MP4, H.264, AVI, MP3, WMV, WMA, FLV, MKV, MPEG-1, MPEG-2, 3GP, 3GPP, VOB, DivX, Mov, RM, RMVB, M4A, AAC, WAV, etc, extract audio from DVD movie or video file and convert them to M4A, MP3, AC3, AAC, WMA, WAV, OGG easily and fast with high quality."+
//"<br>"+
//"DVDVideoMedia Free DVD Converter Suite supports almost all the portable devices, such as: PSP, iPod Classic, iPod Touch, iPod Nano, iPhone (4G), iPhone, Zune, Zune 2, Blackberry, Nokia, Creative Zen, iRiver PMP, Archos, PS3, Apple TV, Xbox, iPAD, Mobile Phone, etc. You can enjoy your favorite DVD and video files on them."+
//"<br>"+
//"DVDVideoMedia Free DVD Converter Suite has strong movie editing functions of movie joiner, movie cutter and movie crop for you to edit your movie. It also allows you to customize the settings including video and audio bitrate, resolution, frame rate, etc. You can also choose the audio track and subtitle of DVD to meet your needs."+
//"<br>"+
//"DVDVideoMedia Free DVD Converter Suite is very user-friendly and easy to use, you can convert DVD an video to various video and audio formats with just a few clicks for you mouse. Free download valuable DVDVideoMedia Free DVD Converter Suite, enjoy your wonderful digital life."+
//"</p>");
//		p3.setDownUrl("dvdconvertersuite.exe");
//		p3.setFileName("dvd-converter-suite");
//		p3.setImage("dvdconvertersuite-box.jpg");
//		p3.setName("DVDVideoMedia Free DVD Converter Suite");
//		p3.setPrice(39.00);
//		p3.setScreenShot("dvdconvertersuite.jpg");
//		p3.setShortDesc("DVDVideoMedia Free DVD Converter Suite is the perfect combination of DVDVideoMedia Free DVD Ripper, DVDVideoMedia Free Video Converter.");
//		p3.setSize("12.6Mb");
//		p3.setShortName("Free Free DVD Converter Suite");
//		p3.setOrderNum(1);
...
//		s.save(p3);
		...
		p4.setCate(c4);
		p4.setDescription("<p><strong>DVDVideoMedia Free Audio Converter</strong> is a powerful all-in-one professional audio converter for audio conversion, audio extraction, audio CD ripping . Using DVDVideoMedia Free Audio Converter, you can convert between different audio formats including <strong>MP3, WMA, WAV, AAC, FLAC, OGG, APE, such as you can convert video to mp3, rip audio from popular video formats including high-definition (HD) videos such as AVI, MPEG, WMV, MP4, FLV, MKV, H.264/MPEG-4 AVC, AVCHD</strong>, rip music CD to different audio formats</p>"+
"<p><strong>DVDVideoMedia Free Audio Converter</strong> also allows you to   convert or rip multiple tracks to multiple formats at once, clip audio segments,   merge into a single audio file, and create customized audio files by adjusting a   range of output parameters. Super high audio conversion speed is offered with   multi-core CPU processing and multithreading both supported. </p>");
		p4.setDownUrl("AudioConverter.exe");
		p4.setFileName("free-audio-converter");
		p4.setImage("audio-converter-box.jpg");
		p4.setName("DVDVideoMedia Free Audio Converter");
		p4.setPrice(24.95);
		p4.setScreenShot("audio-s.jpg");
		p4.setShortDesc("DVDVideoMedia Free Audio Converter is a powerful all-in-one professional audio converter for audio conversion, audio extraction, audio CD ripping.");
		p4.setSize("8.06Mb");
		p4.setShortName("Free Free Audio Converter");
		p4.setOrderNum(1);
		p4.setVersion("V2.1");
...
//		p5.setName("DVDVideoMedia Free Video Converter for Mac");
//		p5.setPrice(29.95);
...
//		p5.setSize("8.06Mb");
//		p5.setShortName("Free Video Converter for Mac");
//		p5.setOrderNum(1);
//		p5.setIcon("new");
//		p5.setVersion("V2.1");
...
//		s.save(p5);
		...
		p6.setSize("7.15Mb");
		p6.setShortName("Free DVD Ripper");
		p6.setOrderNum(2);
		p6.setIcon("hot");
		...
		p7.setSize("7.08Mb");
		p7.setShortName("Free DVD Audio Ripper");
		p7.setOrderNum(3);
		p7.setIcon(null);
		p7.setVersion("V2.1");
		...
		p8.setSize("5.01Mb");
		p8.setShortName("Free MP4 Video Converter");
		p8.setOrderNum(5);
		p8.setIcon(null);
		p8.setVersion("V2.1");
		...
		p9.setCate(c1);
		p9.setDescription("<p>DVDVideoMedia Free AVI Video Converter is one first-class AVI Converter to convert <strong>F4V to AVI, RMVB to AVI, ASF to AVI</strong> etc. and other popular video formats to AVI formats, which is high compatible with different types of Creative Zen, BlackBerry, Wii, PSP, PS3 and other devices. More specially, DVDVideoMedia Free AVI Converter supports different converting formats, including MPEG, MPEG-4, RM, WMV, ASF, TS, MKV, AVI, 3GP, MPV, MOD, TOD, FLV, etc to AVI. It goes without saying that it can convert convert M4A, MP3, AC3, AAC, WMA, WAV, OGG, AU, Nut, AIFF, FLAC, AMR, MIDI audio formats and take out the audio from video formats to AAC, AC3, MP3, M4A, MP2, WAV.                 </p>");
		p9.setDownUrl("AVIVideoConverter.exe");
		p9.setFileName("avi-video-converter");
		p9.setImage("avi-video-converter-box.jpg");
		p9.setName("DVDVideoMedia Free AVI Video Converter");
		p9.setPrice(29.95);
		...
		p9.setSize("5.01Mb");
		p9.setShortName("Free AVI Video Converter");
		p9.setOrderNum(6);
		p9.setIcon(null);
		p9.setVersion("V2.1");
		...
		p10.setSize("5.01Mb");
		p10.setShortName("Free MOV Video Converter");
		p10.setOrderNum(7);
		p10.setIcon(null);
		p10.setVersion("V2.1");
		...
		p11.setSize("5.01Mb");
		p11.setShortName("Free 3GP Video Converter");
		p11.setOrderNum(8);
		p11.setIcon(null);
		p11.setVersion("V2.1");
		...
		p12.setSize("5.01Mb");
		p12.setShortName("Free HD Video Converter");
		p12.setOrderNum(9);
		p12.setIcon(null);
		p12.setVersion("V2.1");
		...
		p13.setName("DVDVideoMedia Free Video to Flash Converter");
		p13.setPrice(24.95);
		...
		p13.setSize("7.55Mb");
		p13.setShortName("Free Video to Flash Converter");
		p13.setOrderNum(10);
		p13.setIcon(null);
		p13.setVersion("V2.1");
		...
		p14.setName("DVDVideoMedia Free PSP Video Converter");
		p14.setPrice(24.95);
		...
		p14.setSize("8.31Mb");
		p14.setShortName("Free PSP Video Converter");
		p14.setOrderNum(11);
		p14.setIcon(null);
		p14.setVersion("V2.1");
		...
		p15.setSize("8.37Mb");
		p15.setShortName("Free Nokia Video Converter");
		p15.setOrderNum(12);
		p15.setIcon(null);
		p15.setVersion("V2.1");
		...
		p16.setCate(c1);
		p16.setDescription("<p>DVDVideoMedia Free DVD to 3GP Converter is designed for Nokia, Motorola, Sony Ericsson and other mobile phones.<br>DVDVideoMedia Free DVD to 3GP Converter provides an excellent solution for 3GP mobile phone users to convert DVD to 3GP format, including 3GP, 3G2, MPEG4, AMR and so on, for playback on their mobile phones with super fast conversion speed and excellent output quality. <br>DVDVideoMedia Free DVD to 3GP Converter provides various powerful editing options such as DVD movie trimming, effect settings, video and audio encoder settings, batch conversion and so on. Extremely fast conversion speed and friendly user interface let you convert video files between many formats with ease.<br>Free download DVDVideoMedia Free DVD to 3GP Converter now and turn your favorite DVD to 3GP movies and 3GP music videos for your mobile phone!<br>                </p>");
		p16.setDownUrl("DVDto3GP.exe");
		p16.setFileName("dvd-to-3gp-converter");
		p16.setImage("dvd-to-3gp-box.jpg");
		p16.setName("DVDVideoMedia Free DVD to 3GP Converter");
		p16.setPrice(24.95);
		p16.setScreenShot("DVDto3GP.jpg");
		p16.setShortDesc("DVDVideoMedia Free DVD to 3GP Converter is designed for Nokia, Motorola, Sony Ericsson and other mobile phones.");
		p16.setSize("8.37Mb");
		p16.setShortName("Free DVD to 3GP Converter");
		p16.setOrderNum(13);
		p16.setIcon(null);
		p16.setVersion("V2.1");
		...
		p17.setCate(c1);
		p17.setDescription("<p>DVDVideoMedia Free DVD to AVI Converter is a professional DVD to AVI Converter with super fast conversion speed and excellent quality. It can convert DVD to AVI, H.264 AVI, DivX, XviD, MPEG-1, MPEG-2, and convert DVD to HD AVI, DivX HD, XviD HD efficiently. These converted files can be played on your popular players including Xbox, Xbox 360, Archos, Creative Zen, iRiver, BlackBerry, PSP, PS3, Wii.<br>DVDVideoMedia Free DVD to AVI Converter fully support you to customize your settings - video and audio bitrate, resolution, frame rate, Sample Rate, etc. You can select target subtitle and audio track in the light of your need.<br>DVDVideoMedia Free DVD to AVI Converter has powerful function of trimming, cropping, merging and effecting. In the process of converting, you can easily adjust and see the effects of video brightness, contrast and saturation at the same time.<br>                </p>");
		p17.setDownUrl("DVDtoAVI.exe");
		p17.setFileName("dvd-to-avi-converter");
		p17.setImage("dvd-to-avi-box.jpg");
		p17.setName("DVDVideoMedia Free DVD to AVI Converter");
		p17.setPrice(24.95);
		...
		p17.setSize("8.37Mb");
		p17.setShortName("Free DVD to AVI Converter");
		p17.setOrderNum(14);
		p17.setIcon(null);
		p17.setVersion("V2.1");
		...
		p18.setCate(c1);
		p18.setDescription("<p>DVDVideoMedia Free DVD to FLV Converter is a professional DVD to FLV converter with super fast conversion speed and excellent quality. It can convert DVD to FLV, SWF for Youtube, Myspace and Google video,etc.<br>DVDVideoMedia Free DVD to FLV Converter also allows you to select target subtitle and audio track. The converted small sized Flash Video can be easily shared with your friends and family by E-mail, FTP upload, or just regular storage devices.<br>DVDVideoMedia Free DVD to FLV Converter has powerful function of trimming, cropping, merging, and effecting. In the process of converting, you can easily adjust and see the effects of video brightness, contrast and saturation at the same time. Only a few clicks to convert your DVD to FLV and enjoy it on the web with others for your ideal life.<br>                </p>");
		p18.setDownUrl("DVDtoFlash.exe");
		p18.setFileName("dvd-to-flash-converter");
		p18.setImage("dvd-to-flash-box.jpg");
		p18.setName("DVDVideoMedia Free DVD to Flash Converter");
		p18.setPrice(24.95);
		...
		p18.setSize("8.37Mb");
		p18.setShortName("Free DVD to Flash Converter");
		p18.setOrderNum(15);
		p18.setIcon(null);
		p18.setVersion("V2.1");
		...
		p19.setCate(c1);
		p19.setDescription("<p>DVDVideoMedia Free DVD to HD Converter can convert DVD to various HD formats with no limitation. High-Definition video<br>Besides supporting versatile HD formats, DVDVideoMedia Free DVD to HD Converter also allows you editing function and customize advanced parameters is supported as well. Capture pictures and preview are also allowed with ideal DVD to HD Converter. To hold DVD to HD Converter at hand let you enjoy colorful videos at iPod, iPhone, Xbox,Blackberry and almost all portable devices at anytime and anyplace. In addition, both novice and beginners can convert DVD to HD with friendly-use interface provided by DVD to HD Converter. Why not try DVDVideoMedia Free DVD to HD Converter right now? Free download supported!<br>               </p>");
		p19.setDownUrl("DVDtoHD.exe");
		p19.setFileName("dvd-to-hd-converter");
		p19.setImage("dvd-to-hd-box.jpg");
		p19.setName("DVDVideoMedia Free DVD to HD Video Converter");
		p19.setPrice(24.95);
		p19.setScreenShot("DVDtoHD.jpg");
		p19.setShortDesc("DVDVideoMedia Free DVD to HD Converter can convert DVD to various HD formats with no limitation.");
		p19.setSize("8.37Mb");
		p19.setShortName("Free DVD to HD Video Converter");
		p19.setOrderNum(16);
		p19.setIcon(null);
		p19.setVersion("V2.1");
		...
		p20.setCate(c1);
		p20.setDescription("<p>DVDVideoMedia Free DVD to Mobile Phone Converter is professional DVD to Mobile Phone Converter software, which helps you rip and convert DVD to Mobile Phone 3GP, MP4, AVI, 3G2 and other video and audio formats. The output videos/audios can be played on most popular Mobile Phones including Nokia, Samsung, Motorola, LG, Sony Ericsson, Palm, etc.<br>Compared with other DVD to Mobile Phone ripping software, DVDVideoMedia Free DVD to Mobile Phone Converter possesses more powerful editing functions. When converting DVD to Mobile Phone, you can adjust output video effect, trim any part of DVD, crop the video play region and specify the output settings, select target subtitle and audio track and so on.<br>                </p>");
		p20.setDownUrl("MobilePhone.exe");
		p20.setFileName("dvd-to-mobile-converter");
		p20.setImage("dvd-to-mobile-box.jpg");
		p20.setName("DVDVideoMedia Free DVD to Mobile Phone Converter");
		p20.setPrice(24.95);
		...
		p20.setSize("8.37Mb");
		p20.setShortName("Free DVD to Mobile Phone Converter");
		p20.setOrderNum(17);
		p20.setIcon(null);
		p20.setVersion("V2.1");
		...
		p21.setCate(c1);
		p21.setDescription("<p>DVDVideoMedia Free DVD to MOV Converter is an easy-to-use DVD MOV Converter to convert DVD files to MOV . With all popular codec built in, it can convert DVD movies to all popular video/audio formats like MOV, MP4, 3GP, MPEG, WMV, MPG, FLV, MP3, M4A, WMA, WAV etc. with super fast speed and high quality. DVDVideoMedia Free DVD to MOV Converter also presets many parameters for your portable player. You can easily convert DVD to your iPod, PSP, Zune etc. With DVDVideoMedia Free DVD to MOV Converter you can enjoy your DVD movies on your PCs and portable devices any time and any where without DVD discs.Free to try and when you buy it you can always get free technical support and upgrade.<br>                </p>");
		p21.setDownUrl("DVDtoMOV.exe");
		p21.setFileName("dvd-to-mov-converter");
		p21.setImage("dvd-to-mov-box.jpg");
		p21.setName("DVDVideoMedia Free DVD to MOV Converter");
		p21.setPrice(24.95);
		...
		p21.setSize("8.37Mb");
		p21.setShortName("Free DVD to MOV Converter");
		p21.setOrderNum(18);
		p21.setIcon(null);
		p21.setVersion("V2.1");
		...
		p22.setCate(c1);
		p22.setDescription("<p>DVDVideoMedia Free DVD to MP4 Converter is the best DVD to MP4 Converter, which can help you convert DVD to MP4, H.264/MPEG-4 AVC (.mp4), MOV, AVI, and convert DVD to HD MP4, HD MOV, HD AVI, DVD to audio like M4A, MP3, AAC, etc for all MP4 players such as iPod, iPod touch, iPod nano, iPhone, iPhone 3G, iPhone 3GS, PSP, Creative Zen, Zune, Zune 2, iRiver PMP, Archos, PS3, Xbox, and more.<br>Compared with other DVD to MP4 converters, DVDVideoMedia Free DVD to MP4 Converter provides more settings for you to customize - video and audio bitrate, resolution, frame rate, Sample Rate, etc, in addition to the default profiles. It also has powerful editing function for you to trim, crop, and effect your output file.<br><br>                </p>");
		p22.setDownUrl("DVDtoMP4.exe");
		p22.setFileName("dvd-to-mp4-converter");
		p22.setImage("dvd-to-mp4-box.jpg");
		p22.setName("DVDVideoMedia Free DVD to MP4 Converter");
		p22.setPrice(24.95);
		...
		p22.setSize("8.37Mb");
		p22.setShortName("Free DVD to MP4 Converter");
		p22.setOrderNum(19);
		p22.setIcon(null);
		p22.setVersion("V2.1");
		...
		p23.setCate(c1);
		p23.setDescription("<p>DVDVideoMedia Free DVD to PSP Converter is the professional DVD to PSP Converter program, which helps you to convert DVD to PSP MP4, convert DVD to PS3 MP4, even DVD to PSP H.264 (.psp), PS3 AVI and extract audio track from DVD to MP3, AAC PSP audio formats. It supports many other portable devices as well.<br>Compared with other DVD to PSP converters, DVDVideoMedia Free DVD to PSP Converter has more settings you can customize. For example, this perfect DVD converter to PSP format allows you to convert DVD to PSP by customizing file size, ripping DVD's any segment, selecting target subtitle and audio track, etc.<br>                </p>");
		p23.setDownUrl("DVDtoPSP.exe");
		p23.setFileName("dvd-to-psp-converter");
		p23.setImage("dvd-to-psp-box.jpg");
		p23.setName("DVDVideoMedia Free DVD to PSP Converter");
		p23.setPrice(24.95);
		...
		p23.setSize("8.37Mb");
		p23.setShortName("Free DVD to PSP Converter");
		p23.setOrderNum(20);
		p23.setIcon(null);
		p23.setVersion("V2.1");
		...
		p24.setSize("8.37Mb");
		p24.setShortName("Free DVD to WMV Converter");
		p24.setOrderNum(21);
		p24.setIcon(null);
		p24.setVersion("V2.1");
		...
		p25.setSize("8.37Mb");
		p25.setShortName("Free DVD to Zune Converter");
		p25.setOrderNum(22);
		p25.setIcon(null);
		p25.setVersion("V2.1");
...
//		p26.setCate(c3);
//		p26.setDescription("<p>DVDVideoMedia Free Audio Converter for Mac is a  powerful all-in-one professional audio converter for audio conversion, audio  extraction, audio CD ripping on MAC OS X . Using DVDVideoMedia Free Audio Converter for  Mac, you can <strong>convert between different audio formats including MP3, WMA, WAV,  AAC, FLAC, OGG, APE</strong>, extract audio from popular video formats including  high-definition (HD) videos such as AVI, MPEG, WMV, VOB, RMVB, XviD,MP4, FLV,  MKV, H.264/MPEG-4 AVC</p>"+
//"<p><strong>Platform</strong>: Mac OS X&nbsp;&nbsp;<a href=\"../free-audio-converter/free-audio-converter.html\">Go to Windows Version &gt;&gt;</a>				</p>");
//		p26.setDownUrl("audio-converter-mac.dmg");
//		p26.setFileName("audio-converter-mac");
//		p26.setImage("audio-converter-box.jpg");
//		p26.setName("DVDVideoMedia Free Audio Converter for Mac");
//		p26.setPrice(24.95);
...
//		p26.setSize("8.06Mb");
//		p26.setShortName("Free Audio Converter for Mac");
//		p26.setOrderNum(2);
//		p26.setIcon("new");
//		p26.setVersion("V2.1");
...
//		s.save(p26);
		...
		p27.setSize("8.06Mb");
		p27.setShortName("Free WMA MP3 Converter");
		p27.setOrderNum(2);
		p27.setVersion("V2.1");
		...
		p28.setName("DVDVideoMedia Free Video to Audio Converter");
		p28.setPrice(24.95);
		...
		p28.setSize("5.06Mb");
		p28.setShortName("Free Video to Audio Converter");
		p28.setOrderNum(3);
		p28.setVersion("V2.1");
		...
		p29.setSize("7.07Mb");
		p29.setShortName("Free DVD to iPad Converter");
		p29.setOrderNum(2);
		...
		p30.setName("DVDVideoMedia Free iPad Video Converter");
		p30.setPrice(24.95);
		...
		p30.setSize("8.11Mb");
		p30.setShortName("Free iPad Video Converter");
		p30.setOrderNum(3);
...
//		p31.setCate(c2);
//		p31.setDescription("<p align=\"left\">DVDVideoMedia Free DVD to iPhone Suite has the function of DVDVideoMedia Free DVD to iPhone Converter and DVDVideoMedia Free iPhone Video Converter, so with DVDVideoMedia Free DVD to iPhone Suite you can convert both DVD movie and video files to MP4, MOV, H.264, MP3, M4A formats.<br>DVDVideoMedia Free DVD to iPhone Suite is also a professional audio converter that can convert audio files including MP3, MP2, AAC, AC3, WAV, MID, MIDI, WMA, M4A, RA, RAM to iPhone/iPhone 3G/iPhone 3GS/ iPhone 4/iPod Touch/iPod Classic/iPod Nano MP3, M4A, AAC audio formats.<br>Compared with other conversion software, DVDVideoMedia Free DVD to iPhone Suite has multifunctional editing system. You can use it to join movie, cut movie and crop movie. You can also customize the settings including video and audio bitrate, resolution, frame rate, etc. The audio track and subtitle settings are also available for you. It is totally costumer-oriented. </p>");
//		p31.setDownUrl("iPhoneConverterSuite.exe");
//		p31.setFileName("iphone-converter-suite");
//		p31.setImage("iphoneconvertersuite-box.jpg");
//		p31.setName("DVDVideoMedia Free iPhone Converter Suite");
//		p31.setPrice(24.95);
//		p31.setScreenShot("iphone-converter-suite-bk.jpg");
//		p31.setShortDesc("Has the function of DVDVideoMedia Free DVD to iPhone Converter and DVDVideoMedia Free iPhone Video Converter, so you can convert both DVD movie and video files to MP4, MOV, H.264, MP3, M4A formats.");
//		p31.setSize("12.7Mb");
//		p31.setShortName("Free iPhone Converter Suite");
//		p31.setOrderNum(4);
...
//		s.save(p31);
		...
		p32.setSize("8.20Mb");
		p32.setShortName("Free DVD to iPhone Converter");
		p32.setOrderNum(5);
		...
		p33.setName("DVDVideoMedia Free iPhone Video Converter");
		p33.setPrice(24.95);
		...
		p33.setSize("8.30Mb");
		p33.setShortName("Free iPhone Video Converter");
		p33.setOrderNum(6);
		...
		p34.setCate(c2);
		p34.setDescription("<p align=\"left\">DVDVideoMedia Free DVD to iPod Converter is the most professional DVD to iPod converter software to DVD to iPod Touch, DVD to iPod Nano, DVD to iPod Classic. You can easily convert almost all kinds of DVDs to iPod MP4 video, MP4 AVC video, MOV, M4V and iPod MP3 etc audio with the latest MPEG-4 video encoding technology. You will enjoy your favorite DVDs on your iPhone/iPhone 3GS/iPhone 4/ iPod Nano/iPod Classic and Apple TV without any difficulties.As the best customer-oriented DVD to iPod Converter software, DVDVideoMedia Free DVD to iPod Converter provides rich options such as DVD movie trimming, DVD movie cropping, DVD video effect, subtitle and audio track selection, snapshot favorite picture and so forth. It is easy-to-use and a few clicks are enough to finish your conversion job. Free Download DVDVideoMedia Free DVD to iPod Converter and have a try! Enjoy your favorite DVD movies on your iPod anytime and anywhere. </p>");
		p34.setDownUrl("DVDtoipod.exe");
		p34.setFileName("dvd-to-iPod-converter");
		p34.setImage("dvd-to-ipod-box.jpg");
		p34.setName("DVDVideoMedia Free DVD to iPod Converter");
		p34.setPrice(24.95);
		...
		p34.setSize("7.10Mb");
		p34.setShortName("Free DVD to iPod Converter");
		p34.setOrderNum(7);
		...
		p35.setName("DVDVideoMedia Free ipod Video Converter");
		p35.setPrice(24.95);
		...
		p35.setSize("8.30Mb");
		p35.setShortName("Free ipod Video Converter");
		p35.setOrderNum(8);
		...
		p36.setName("Free DVDVideoMedia Free Video Converter");
		p36.setPrice(null);
		p36.setScreenShot("free.jpg");
		p36.setShortDesc("DVDVideoMedia Free video converter is freeware for users.All-in-one powerful video converter software to convert all videos Between AVI, MPEG, WMV, H.264/AVC, DivX, MP4, MKV, RM, MOV, XviD, 3GP, FLV and other video formats; Download it now and you will be surprised by this amazing Video Converter.");
		p36.setSize("5.20Mb");
		p36.setShortName("Free Free DVDVideoMedia Free Video Converter");
...
//		p37.setName("DVDVideoMedia Free iPad Video Converter for Mac");
//		p37.setPrice(24.95);
...
//		p37.setSize("8.06Mb");
//		p37.setShortName("Free iPad Video Converter for Mac");
//		p37.setOrderNum(3);
//		p37.setIcon("new");
...
//		s.save(p37);
	...
	private static Set<Feature> getFeature2(Product p){
		...
		"DVDVideoMedia Free iPad Converter Suite enables you to trim any segment of a video or audio you like. Also you can crop the aspect ratio to fit your player screen and cut off the unwanted areas of the video. "));
		set.add(buildFeature("Edit video effect ",
		"With the help of DVDVideoMedia Free iPad Converter Suite, you can adjust video brightness, contrast and saturation for the customized playing effect. "));
		set.add(buildFeature("Merge video ",
		"DVDVideoMedia Free iPad Converter Suite provides you the function of joining multiple pieces of videos or audios together for you to enjoy. "));
		...
		set.add(buildFeature("Preview and snapshot ","The built-in player of DVDVideoMedia Free iPad Converter Suite enables you to preview the original video and the output video effect during the process of converting or editing for you to get a fully control of the video effect. While previewing videos, you can capture any picture you like and save it as JPEG, GIF or BMP format. "));
		set.add(buildFeature("Easy to use ","The user-friendly interface of DVDVideoMedia Free iPad Converter Suite makes the operation quite easy for both beginners and advanced users. After a few mouse clicks, this magic software will do the rest work for you. "));
...
//		set.add(buildFeature("",""));
	...
	private static Set<Feature> getFeature3(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Convert DVD and any video/audio to the various video/audio formats ","DVDVideoMedia Free DVD Converter Suite software could easily convert DVD and any video to the various video/audio formats such as MP4, H.264, AVI, MP3, WMV, WMA, FLV, MKV, MPEG-1, MPEG-2, 3GP, 3GPP, VOB, DivX, Mov, RM, RMVB, M4A, AAC, WAV, etc. "));
		set.add(buildFeature("Support almost all popular portable players ","DVDVideoMedia Free DVD Converter Suite software can convert DVD and video to all the popular devices: PSP, iPod Classic, iPod Touch, iPod Nano, iPhone (3G), iPhone, Zune, Zune 2, Blackberry, Nokia, Creative Zen, Sony Walkman, iRiver PMP, Archos, PS3, Apple TV, Xbox, iPad, Mobile Phone, etc."));
		set.add(buildFeature("Easy and powerful editing function (Merge, Trim, Crop) ","DVDVideoMedia Free DVD Converter Suite software offers powerful editing functions such as merging multiple DVD chapters, titles or different videos files into one file, trimming any clip of video or DVD, cropping video size and so forth. "));
		...
		set.add(buildFeature("Preview video effect when you manage it ","With DVDVideoMedia Free DVD Converter Suite, it provides the original video preview and output video preview, you can see the video effect when you manage it."));
		...
		set.add(buildFeature("Easy to use ","DVDVideoMedia Free DVD Converter Suite is very user-friendly and easy to use. Only a few clicks to complete the conversion with supervising the whole process on real time. "));
		set.add(buildFeature("Fastest Conversion Speed ","Provide the fastest conversion speed (>300%), completely support dual core CPU. "));
		return set;
	}
...
"    Ready support Google Android phones and iPad: Samsung i7500, Motorola CLIQ, Motorola Droid, HTC Tattoo, HTC G2 Magic, HTC Hero, Nexus One"));
	...
	private static Set<Feature> getFeature6(Product p){
		...
		set.add(buildFeature("Fastest way to output diverse formats from DVD ","DVDVideoMedia Free DVD Ripper supports to convert DVD to different video or audio formats at one time conveniently. "));
		...
		set.add(buildFeature("Select audio track and subtitle ","DVDVideoMedia Free DVD Ripper allows you to choose the audio track and subtitle for your converted video. "));
	...
	private static Set<Feature> getFeature7(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Rip DVD to all popular audio formats and Extract audio from DVD movies","DVDVideoMedia Free DVD Audio Ripper can rip DVD to the most popular audio formatsAAC, AC3, AIFF, AMR, AU, FLAC, MP3, M4A, MP2, OGG, WAV, WMA and extract the audio from the DVD movies. "));
		...
		set.add(buildFeature("Easy and powerful DVD audio ripping ( Trim) ","DVDVideoMedia Free DVD Audio Ripper offers powerful DVD audio trimming function to capture any DVD clips exactly by setting the start and end time. "));
	...
	private static Set<Feature> getFeature8(Product p){
		...
		set.add(buildFeature("Easier operation and better quality ","Friendly user interface<br/>An intuitively designed user interface brings you more convenience and enjoyment.<br/>Fast speed and high video quality<br/>With professional video encoding and decoding technique, DVDVideoMedia Free MP4 Video Converter brings you the advanced and high speed converting process. "));
	...
	private static Set<Feature> getFeature9(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Support convert all popular videos to AVI, HD AVI, HD MPG, HD TS ","DVDVideoMedia Free AVI Video Converter gives you a hand to get AVI, and HD AVI videos from all popular videos, like MPEG, MPEG-4, RM, WMV, ASF, TS, MKV, AVI, 3GP, FLV, etc. "));
	...
	private static Set<Feature> getFeature12(Product p){
		...
		set.add(buildFeature("Make HD video available in various formats ","DVDVideoMedia Free HD Video Converter can convert HD video to almost all available formats, e.g. AVI, MP4, WMV, MKV, RMVB, FLV, MPG, MOV, VOB, 3GP. "));
		...
		set.add(buildFeature("Crop the video image for better display ","To make the HD video display better on different screens, e.g. TV screen, projector canvas, mobile phone screen, DVDVideoMedia Free HD Video Converter offers 4:3, 16:9, pan scan crop presets as well as the opportunity to customize. "));
		return set;
	}
	...
	private static Set<Feature> getFeature15(Product p){
		...
		set.add(buildFeature("Fast speed and high video quality ","With professional video encoding and decoding technique, DVDVideoMedia Free Nokia Video Converter brings you the advanced and high speed converting process. "));
	...
	private static Set<Feature> getFeature17(Product p){
		...
		set.add(buildFeature("trim, merge and crop video ","Clip any part of the DVD movie into video clips by accurately setting start time and end time or just dragging the slider bar to the position where you want to stop the trimming. Merge many DVD titles/chapters into one by checking the \"Merge into one file\" option. With DVDVideoMedia Free DVD to AVI Converter you can remove black edges of your DVD movie and crop movie image size by using its \"Crop\" function. You can also select the \"Zoom\" mode to extrude your video slightly to adjust to iPod so you can get the best video quality. "));
		set.add(buildFeature("Support preview and take favorite image ","You can preview the source video and edited video and compare the before and after files for your further operation. If you like the current image of the video you can use the \"Snapshot\" option to take a snapshot of the film and save as a picture file. You can select the destination of the picture by clicking the \"Preferences\" button. "));
	...
	private static Set<Feature> getFeature18(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Directly convert DVD to FLV, SWF with a flash player ","DVDVideoMedia Free DVD to FLV Converter can perfectly convert DVD to FLV, SWF for you to upload to Youtube, Myspace and Google video. "));
		...
		set.add(buildFeature("Crop your video ","With DVDVideoMedia Free DVD to FLV Converter you can remove black edge of your DVD movie and get any playing area of the video by using its \"Crop\" function. You can also select the \"Zoom\" mode to extrude your video slightly to adjust to your portable devices so you can get the best video quality. "));
		set.add(buildFeature("Support preview and take favorite image ","You can preview the source video and edited video and compare the before and after files for your further operation. If you like the current image of the video you can use the \"Snapshot\" option to take a snapshot of the film and save as a picture file. You can select the destination of the picture by clicking the \"Preferences\" button. "));
		set.add(buildFeature("Easy to use ","A few clicks are all you need to do to rip and copy DVD movies. "));
	...
	private static Set<Feature> getFeature19(Product p){
		...
		set.add(buildFeature("trim, merge and crop video ","Clip any part of the DVD movie into video clips by accurately setting start time and end time or just dragging the slider bar to the position where you want to stop the trimming. Merge many DVD titles/chapters into one by checking the \"Merge into one file\" option. With DVDVideoMedia Free DVD to HD Converter you can remove black edges of your DVD movie and crop movie image size by using its \"Crop\" function. You can also select the \"Zoom\" mode to extrude your video slightly to adjust to iPod so you can get the best video quality. "));
		set.add(buildFeature("Support preview and take favorite image ","You can preview the source video and edited video and compare the before and after files for your further operation. If you like the current image of the video you can use the \"Snapshot\" option to take a snapshot of the film and save as a picture file. You can select the destination of the picture by clicking the \"Preferences\" button. "));
	...
	private static Set<Feature> getFeature20(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("DVD to Mobile Phone video and audio converter ","With this perfect DVDVideoMedia Free DVD to Mobile Phone Converter you can easily convert DVD to Mobile Phone video formats including 3GP, 3G2, MPEG-4, H.264/MPEG-4 AVC, WMV, AVI, and AAC, MP3, M4A, WMA, MP2, WAV audio formats. "));
	...
	private static Set<Feature> getFeature21(Product p){
		...
		set.add(buildFeature("trim, merge and crop video ","Clip any part of the DVD movie into video clips by accurately setting start time and end time or just dragging the slider bar to the position where you want to stop the trimming. Merge many DVD titles/chapters into one by checking the \"Merge into one file\" option. With DVDVideoMedia Free DVD to MOV Converter you can remove black edges of your DVD movie and crop movie image size by using its \"Crop\" function. You can also select the \"Zoom\" mode to extrude your video slightly to adjust to iPod so you can get the best video quality. "));
		set.add(buildFeature("Support preview and take favorite image ","You can preview the source video and edited video and compare the before and after files for your further operation. If you like the current image of the video you can use the \"Snapshot\" option to take a snapshot of the film and save as a picture file. You can select the destination of the picture by clicking the \"Preferences\" button. "));
	...
	private static Set<Feature> getFeature22(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Directly Convert DVD to MP4, H.264/MPEG-4 AVC (.mp4), MOV, AVI ","DVDVideoMedia Free DVD to MP4 Converter can easily convert DVD to MP4, H.264/MPEG-4 AVC (.mp4), MOV, AVI in the highest speed and quality. "));
		...
		set.add(buildFeature("Sync to most players or devices ","DVDVideoMedia Free DVD to MP4 Converter can make your converted video compatible with iPod, iPod touch, iPod touch 2, iPod nano, iPod nano 4, iPod classic, iPhone, iPhone 3G, Apple TV, PSP, PS3, Wii, Zune, Zune 2, Xbox, Xbox 360, Google Phone, Sony Walkman, Archos, Creative Zen, iRiver, BlackBerry, BlackBerry Storm, BlackBerry Bold, Palm Pre, Motorala, LG, Sony Ericsson, Mobile Phone, etc. ."));
		...
		set.add(buildFeature("Merge into one file ","If you want to merge the selected contents into one file you can check the \"Merge into one file\" option. As default the merged file is named after the first selected file (either a title or a chapter)."));
		set.add(buildFeature("Crop your video ","With DVDVideoMedia Free DVD to MP4 Converter you can remove black edge of your DVD movie and get any playing area of the video by using its \"Crop\" function. You can also select the \"Zoom\" mode to extrude your video slightly to adjust to your portable devices so you can get the best video quality. "));
		set.add(buildFeature("Support preview and take favorite image ","You can preview the source video and edited video and compare the before and after files for your further operation. If you like the current image of the video you can use the \"Snapshot\" option to take a snapshot of the film and save as a picture file. You can select the destination of the picture by clicking the \"Preferences\" button. "));
	...
	private static Set<Feature> getFeature23(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Convert DVD to PSP output formats ","The best DVDVideoMedia Free DVD to PSP converter can convert DVD to PSP video and extract audio track from DVD to PSP audio. SD Video: MPEG-4, H.264, H.264/MPEG-4 AVC, AVI, DivX, XviD,WMV HD Video: HD H.264, HD DivX, HD WMV, HD XviD, HD MPEG 4, HD H.264/MPEG-4 AVC Audio: MP3, M4A, WAV, WMA "));
		...
		set.add(buildFeature("Edit Display Effect ","DVDVideoMedia Free DVD to PSP Converter provides the video effect parameters, video Brightness, Contrast, Saturation and audio Volume. "));
	...
	private static Set<Feature> getFeature24(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Directly convert DVD to WMV ","DVDVideoMedia Free DVD to WMV Converter can perfectly convert DVD to WMV, WMA, MP3 in excellent video/audio quality, and super fast conversion speed. "));
	...
	private static Set<Feature> getFeature25(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Convert DVD to Zune compatible videos and audios ","DVDVideoMedia Free DVD to Zune Converter can convert DVD to Zune WMV, MP4, H.264/MPEG-4 AVC(.mp4) video and rip DVD to MP3, WMA, M4A, AAC audio format with excellent output video/audio quality. "));
		set.add(buildFeature("Set video effect ","DVDVideoMedia Free DVD to Zune Converter allows you to adjust the video effect: video Brightness, Contrast, Saturation. "));
		set.add(buildFeature("Trim DVD Movie ","DVDVideoMedia Free DVD to Zune Converter has the trim function. It means that you can get any time-length video clips by setting the exact time or just drag the slider bar. "));
		...
		set.add(buildFeature("Fastest conversion speed ","Provide the fastest conversion speed (>300%), completely support dual core CPU. "));
		set.add(buildFeature("Easy to use ","DVDVideoMedia Free DVD to Zune Converter is really easy to use. The whole process of conversion can be finished in few clicks. "));
		return set;
	}
	...
	private static Set<Feature> getFeature29(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Rip DVD to iPad compatible video formats ","DVDVideoMedia Free DVD to iPad Converter enables you to convert DVD to iPad Video and audio files including MP4, H.264, MP3, AAC, WMA. "));
		set.add(buildFeature("Extract audios from DVD ","With DVDVideoMedia Free DVD to iPad Converter, you are able to extract any audio you like from your DVD file, and enjoy it on your iPad. "));
		set.add(buildFeature("Trim, crop, merge, watermark ","DVDVideoMedia Free DVD to iPad Converter owns powerful editing functions, such as trimming any segment of a video, cropping the video size, merging several files together. "));
	...
	private static Set<Feature> getFeature31(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Convert DVD and any video/audio to MP4/H.264 ","DVDVideoMedia Free DVD to iPhone Converter Suite could easily convert DVD and video/audio files to iPhone/iPhone (3G), iPhone 3GS/ iPhone 4 MP4, H.264, and MOV. "));
		set.add(buildFeature("Professional function of audio converter ","DVDVideoMedia Free DVD to iPhone Converter Suite could easily convert any audio such as MP3, MP2, AAC, AC3, WAV, MID, MIDI, WMA, M4A, RA, RAM to iPhone M4A/AAC/MP3 audio files."));
		set.add(buildFeature("Easy and powerful editing function (Merge, Trim, Crop) ","DVDVideoMedia Free DVD to iPhone Converter Suite offers powerful editing functions such as merging multiple DVD chapters, titles or different videos files into one file, trimming any clip of video or DVD, cropping video size and so forth. "));
		...
		set.add(buildFeature("Snapshot picture and preview ","With DVDVideoMedia Free DVD to iPhone Suite, it provides the original video preview and output video preview, you can see the video effect when you modify it. If you like the current image of the video you can use the \"Snapshotoption. Just click the \"Snapshotbutton the image will be saved and you can click the \"Openbutton next to \"Snapshotbutton to open your picture. "));
	...
	private static Set<Feature> getFeature32(Product p){
		Set<Feature> set = new TreeSet<Feature>();
		set.add(buildFeature("Convert any DVDs to iPhone video and audio formats ","DVDVideoMedia Free DVD to iPhone Converter can convert DVD to iPhone MP4, H.264/MPEG-4 AVC, MOV, M4V Videos. In addition, it could also convert DVD to AAC, MP3, WAV, AIFF, M4A audio formats. "));
		...
		set.add(buildFeature("Crop your video ","With DVDVideoMedia Free DVD to iPhone Converter you can remove black edge of your DVD movie and get any playing area of the video. "));
	...
	private static Set<Feature> getFeature36(Product p){
		...
		set.add(buildFeature("Preview the movies ","To check the video is right for converting, you are able to preview it on DVDVideoMedia Free video converter."));
