...
public class ProductDetail {
	public static void main(String[] args) throws Exception{
		...
		for(Product p : list){
			...
			System.out.println("dir from:" + map.get("appPath"));
			String fileName = "eahoosoft-video-converter";
			String pFileName = p.getFileName();
			pFileName = pFileName.replaceAll("free-", "eahoosoft-");
			String oldFileName = "EahoosoftVideoConverter";
			if(fileName.equals(pFileName))
				Common.fillPageInfoFromURL(All.SITE_PRE+pFileName+"/"+oldFileName+".html", map);
			else
				Common.fillPageInfoFromURL(All.SITE_PRE+pFileName+"/"+pFileName+".html", map);
