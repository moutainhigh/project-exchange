	  ...
	  <div id="contents">
	    ...
	    <div id="mainContents">
	      <div class="newsList noBg"> 
            ...
            <br>
            And we recommend you read the <span class="p1"><a href="faqs.html">FAQs</a></span> first. Maybe there are answers to your questions. If you still have additional questions or problems, please email us. <br>
            <br>
            Technical Support<br>
            please send an email to: <strong><span class="p1"><a href="#"><u></u></a><u><a href="mailto:analysts@hotmail.com">analysts@hotmail.com</a></u></span></strong> <br>
