	    ...
	    <div id="mainContents">
	      <div class="newsList noBg"> 
			...
			<img src="images/arrow.gif" width="10" />&nbsp;&nbsp;&nbsp;<strong>For Technical Support</strong><br />
             please send an email to:  <strong><span class="p1"><a href="#"><u><a href="mailto:analysts@hotmail.com">analysts@hotmail.com</u></a></span></strong><br />
            <br />
			...
			<a href="#"><u><a href="mailto:analysts@hotmail.com">analysts@hotmail.com</u></a></span></strong><br />
            <br />
