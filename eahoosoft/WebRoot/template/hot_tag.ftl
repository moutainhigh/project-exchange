...
<body>
	<div id="wrap">
	  ...
	  <div id="contents">
	    <div id="location"><a class="localtionIndex" href="${appPath}index.html">Home</a>|<a class="localtionTwo" href="${appPath}${p.fileName}/${p.fileName}.html">Products</a>|<span class="localtionSec">${h.linkName}</span></div>    
		<div id="mainContents">
