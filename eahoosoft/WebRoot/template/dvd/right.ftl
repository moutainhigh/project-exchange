	      <div id="secondContents">
	        ...
	        <div id="divwin0">
	          <ul>
	            ...
	            <#list mList as p>
	            <li><a href="${appPath}${p.dirName!p.fileName}/${p.fileName}.html" class="${p.icon?default("")}">${p.shortName}</a></li>
	            </#list>
	            ...
	            <#list gList as p>
	            <li><a href="${appPath}${p.dirName!p.fileName}/${p.fileName}.html" class="${p.icon?default("")}">${p.shortName?default('')}</a></li>
	            </#list>
