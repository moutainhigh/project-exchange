...
<table height="100%" width="100%" cellspacing="0" cellpadding="0" border="0" class="tables_table">
	...
	<input type="text" datatype="Require" disabled="disabled" size="20" id="pkcmc" value="${cuoshi.zhen.name }" name="cuoshi.zhen.name"><font color="#666666">不能更改，系统自动提取</font>
    </td>
	</tr>
	<tr>
	...
	<input type="text" id="dwmc" datatype="Require" size="20" value="${cuoshi.zhen.shiWorkOrg.orgName }" name="cuoshi.zhen.shiWorkOrg.loginName" disabled="disabled"><font color="#666666">不能更改，系统自动提取</font>
    </c:if>
     <c:if test="${userObj.roleType=='县级管理员'}">
	<input type="text" id="dwmc" datatype="Require" size="20" value="${cuoshi.zhen.areaWorkOrg.orgName }" name="cuoshi.zhen.areaWorkOrg.loginName" disabled="disabled"><font color="#666666">不能更改，系统自动提取</font>
    </c:if>
    </td>
	</tr>    
	<tr>
