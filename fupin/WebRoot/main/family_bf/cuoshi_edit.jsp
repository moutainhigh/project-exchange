...
<input type="hidden" value="${cuoshi.id}" name="cuoshi.id" id="">
  ...
  <tbody><tr>
    ...
    <select id="family" name="cuoshi.family.id" size="1" msg="贫困户不能为空!" datatype="Require"></select><font color="#cc0033">在下拉菜单中选择户</font>
    </td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
		...
		<td class="tables_contentcell"><select name="cuoshi.year">
