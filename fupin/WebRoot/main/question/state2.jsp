			...
			$(function(){
				$('#test').datagrid({
					...
					columns:[[
				        ...
				        {field:'ok1',title:'贫困户总数',width:100,align:'center'},
				        {field:'ok2',title:'已填报户数',width:100,align:'center'},
				        {field:'ok3',title:'申请解锁中的户数',width:100,align:'center'}
					]],
					//pagination:true,
					rownumbers:true,
					pageSize:10
	...
	<body>
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tables_search">
			<tbody>
				<tr>
					<td>
						您当前所处页面：考评调查表（二）填报情况
					</td>
					<td align="right">
					&nbsp;
					<form action="${appPath}question_state2.action" method="get">
					年度：
