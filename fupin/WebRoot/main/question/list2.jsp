...
.tables_search {
	...
	<body>
		<form method="get" action="${appPath}question_list2.action?year=${year}" name="searchForm">
					...
					<c:forEach items="${pageBean.resultList}" var="f">
						<tr>
							...
							<td height="25" align="center" class="tables_contentcell">
								...
								<a href="javascript:void(0);" onclick="winOpen('${appPath}question_show2.action?q2.id=${f.id}&year=${year }',800,600);">查看</a>
								<a href="javascript:void(0);" onclick="winOpen('${appPath}question_edit2.action?q2.id=${f.id}&year=${year }',800,600);">编辑</a>
							</td>
						</tr>
					</c:forEach>
					<tr>
