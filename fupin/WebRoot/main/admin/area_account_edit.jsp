...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form method="get" onsubmit="return Validator.Validate(this);" action="${appPath}shi_saveOrUpdateAreaWorkOrg.action" name="">
				...
				<tbody>
					<tr>
						...
						<td class="tables_contentcell">
							<select id="shiworkorg" name="shiWorkOrg.shi.id" size="1" msg="必须选择一个市扶贫办！" datatype="Require"></select>
