...
<form method="get" action="${appPath}shenhe_showAllCuoshiFamilyInPro.action" name="searchForm">
...
<td width="6%" class="tables_headercell">
				...
				<td height="25" align="center" class="tables_contentcell">	${f.id }</td>
					...
					<td height="25" align="center" class="tables_contentcell">
					<a href="${appPath}shenhe_passCuoshiFamily.action?cuoshiFamily.id=${f.id}" >通过</a>
					<a href="${appPath}shenhe_notpassCuoshiFamily.action?cuoshiFamily.id=${f.id}" >不通过</a>
					</td>
				</tr>
					</c:forEach>
				<tr>
