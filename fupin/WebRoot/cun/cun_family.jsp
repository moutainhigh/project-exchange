...
<c:forEach items="${pageBean.resultList}" var="f">
		...
		&nbsp;
		 <a onmouseout="hideToolTip()" onmouseover="showToolTip(event,typetip(3));return false" style="border-bottom: 1px dotted rgb(49, 112, 130); color: rgb(48, 112, 130);" href="#">${f.type }</a>
		</td>
		<td height="25" align="center" class="tables_contentcell">
		&nbsp;${f.tuopin }
		</td>
