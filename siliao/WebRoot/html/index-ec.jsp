...
function initialise() {
	...
	L0102 = theMenu.addChild(L01, "Document", "新建单据", "bill/addBill.html", "养殖户或者饲料经理建立草稿单据...");
	...
	L0305 = theMenu.addChild(L03, "Document", "邮件设定", "account/service/mail_setting.jsp", "设定系统自动发送邮件....");
