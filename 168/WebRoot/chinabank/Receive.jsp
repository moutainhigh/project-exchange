...
<%@page import="com.throne212.info168.web.domain.Finance"%>
<%@page import="com.throne212.info168.web.common.WebConstants"%>
<%@page import="com.throne212.info168.web.domain.User"%>
<%@page import="java.util.Date"%>
<%@page import="org.springframework.context.ApplicationContext"%>
<%@page import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="com.throne212.info168.web.biz.UserBiz"%>
...
if (v_md5str.equals(v_md5))
{
	if ("30".equals(v_pstatus))
	{
		...
		f.setDate(new Date());
		f.setMoney(Double.parseDouble(v_amount));
		f.setOrderNo(v_oid);
		f.setUser((User)session.getAttribute(WebConstants.SESS_USER_OBJ));
