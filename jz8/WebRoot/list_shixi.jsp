				...
				<DIV id=category>
					<UL class=transverse>
						...
						<LI>
							...
							<A href="/shixi/" id="${t.id.typeCode}" <c:if test="${typeId==t.id.typeCode}">style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% rgb(0, 64, 128);"</c:if>>实习工作</A>
								</c:when>
								<c:otherwise>
	...
	new google.ads.search.Ads(pageOptions, options2);
					...
					<div class=p>
						<div style='float: right'>
							...
							<c:if test="${!bean.isFirstPage}">
								<a href="/jianzhi/${typeId}c<c:if test="${ctClass=='1'}">0</c:if>p1">首页</a>
								<a href="/jianzhi/${typeId}c<c:if test="${ctClass=='1'}">0</c:if>p${bean.prePageIndex}" class="pre">上页</a>
							</c:if>
							${bean.pagerJianzhi }
							...
							<c:if test="${!bean.isLastPage}">
								<a href="/jianzhi/${typeId}c<c:if test="${ctClass=='1'}">0</c:if>p${bean.nextPageIndex}" class="nxt">下页</a>
							</c:if>
				...
				<div class="search_listing">
					<div class="list_bg">
						...
						热门词:
						<a href='/s/%E6%9A%91%E6%9C%9F%E5%B7%A5%E5%85%BC%E8%81%8C'>暑期工兼职</a>&nbsp;
						<a href="http://sh.jianzhi8.com" target="_blank">上海兼职</a>
						<a href="http://sz.jianzhi8.com" target="_blank">深圳兼职</a>
				...
				<DIV id=category>
					<UL class=transverse>
						热点城市:
						<li>
							<A href="http://bj.jianzhi8.com/jianzhi/">北京兼职工作</A>
						</li>
						<li>
							<A href="http://sh.jianzhi8.com/jianzhi/">上海</A>
						</li>
						<li>
							<A href="http://tj.jianzhi8.com/jianzhi/">天津</A>
						</li>
						<li>
							<A href="http://cq.jianzhi8.com/jianzhi/">重庆</A>
						</li>
						<li>
							<A href="http://gz.jianzhi8.com/jianzhi/">广州</A>
						</li>
						<li>
							<A href="http://sz.jianzhi8.com/jianzhi/">深圳</A>
						</li>
						<li>
							<A href="http://hz.jianzhi8.com/jianzhi/">杭州</A>
						</li>
						<li>
							<A href="http://sjz.jianzhi8.com/jianzhi/">石家庄</A>
						</li>
						<li>
							<A href="http://dl.jianzhi8.com/jianzhi/">大连</A>
						</li>
						<li>
							<A href="http://nj.jianzhi8.com/jianzhi/">南京</A>
						</li>
						<li>
							<A href="http://fz.jianzhi8.com/jianzhi/">福州</A>
						</li>
						<li>
							<A href="http://xm.jianzhi8.com/jianzhi/">厦门</A>
						</li>
						<li>
							<A href="http://zz.jianzhi8.com/jianzhi/">郑州</A>
						</li>
						<li>
							<A href="http://jn.jianzhi8.com/jianzhi/">济南</A>
						</li>
						<li>
							<A href="http://xa.jianzhi8.com/jianzhi/">西安</A>
						</li>
						<li>
							<A href="http://nc.jianzhi8.com/jianzhi/">南昌</A>
						</li>
				</DIV>
				</c:if>
				...
				<DIV style="margin-top: 1px;">
					<P
						...
						网上信息有风险,本站所有${city.simpleName}兼职工作信息均由网友自由发布，请仔细审核，兼职吧招聘网不承担由于内容的合法性及真实性所引起的一切争议和法律责任！
					</P>
				</DIV>
