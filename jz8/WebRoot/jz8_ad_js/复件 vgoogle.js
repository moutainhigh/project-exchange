...
document.writeln("      <input type=\"text\" name=\"keyword\" maxlength=\"20\" class=\"search_jing\" onFocus=\"this.style.color=\'#000000\';if( \'例如：促销 或 打字\' == this.value) this.value=\'\'\" value=\"例如：促销 或 打字\" style=\"FONT-SIZE: 12px; color: #CCCCCC;vertical-align:bottom;\"\/>   ");
