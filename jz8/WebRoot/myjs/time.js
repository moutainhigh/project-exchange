...
//====   中文日期   
  ...
  "0801   建军节","0808   父亲节","0909   毛席逝世纪念","0910   教师节","0928   孔子诞辰","1001*国庆节",   
  ...
  document.write("<table   border='1'   cellspacing='3'   width='105'   bordercolor='#009B00'   bgcolor='#FFFFFF'   height='110'   cellpadding='2'");   
  document.write("<tr><td   align='center'><b><font   color=#008040>"+YYMMDD()+"</font><br><font   face='Arial'   size='6'   color=#FF8040>"+SD+"</font><br><font   color=#008040><span   style='FONT-SIZE:   10.5pt'>");   
...
document.write('<table id="CalendarClockFreeCode" border="0" cellpadding="0" cellspacing="0" width="140" height="70" ');
document.write('style="position:absolute;visibility:hidden" bgcolor="#ffffff">');
document.write('<tr><td align="center">');
document.write('</td></tr></table>'); 

document.write('<table border="0" cellpadding="1" cellspacing="0" width="140" height="70">');
document.write('<tr bgcolor="#d1ee8c"><td align="center" valign="middle" width="100%" height="100%" onmouseover=getCalendarClockFreeCodeMsg("off")>');
document.write('<span id="calendarClock1"  style="color:navy;font-size:14px;font-family:Tahoma;line-height:100%"> </span><br>');
document.write('<span id="calendarClock2" style="font-size:20px;color:Red;font-family:Verdana;line-height:130%"><b> </b></span><br>');
document.write('<span id="calendarClock3" style="font-family:Arial;font-size:9pt;line-height:150%"> </span><br>');
document.write('<span id="calendarClock4" style="font-family:Arial;font-size:9pt;line-height:150%"> </span><br>');
document.write('<span id="calendarClock5" style="color:#000000;font-family:Arial;font-size:12pt;line-height:120%"><b> </b></span>');
document.write('</td></tr></table>');
document.write('</td></tr></table>'); 
...
document.getElementById("calendarClock4").innerHTML = solarDay2(); 
